...
import { X, Package, ListOrdered, Eye, Warehouse, Check, ChevronDown, ChevronUp, Edit, ArrowLeft } from 'lucide-react';
...
export function InventoryDetailSheet({ open, onOpenChange, item }: InventoryDetailSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[85%] sm:max-w-[650px] md:max-w-[950px] overflow-y-auto">
